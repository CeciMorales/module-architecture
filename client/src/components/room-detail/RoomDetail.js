    ...
    return (
        <>
            ...
            <div className="card-body">
                <div class="row">
                    <div class="col mt-2">
                    <h5 className="card-title">Salón: </h5>                
                <p>
                    <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-building mr-2" >
                ...
                <p>
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-tv-fill mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <p>
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-aspect-ratio-fill mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <p>
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plug-fill mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
